...
func (q *Queries) JobGetWorkflowTasks(ctx context.Context, db DBTX, arg *JobGetWorkflowTasksParams) ([]*RiverJob, error) {
	rows, err := db.QueryContext(ctx, jobGetWorkflowTasks, arg.WorkflowID, pq.Array(arg.TaskNames))
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) JobUpdateWorkflowReady(ctx context.Context, db DBTX, arg *JobUpdateWorkflowReadyParams) ([]*RiverJob, error) {
	rows, err := db.QueryContext(ctx, jobUpdateWorkflowReady, arg.Now, arg.Max)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
