...
func (e *Executor) JobCancelWorkflow(ctx context.Context, params *riverdriver.JobCancelWorkflowParams) ([]*rivertype.JobRow, error) {
	...
	schemaParam := sql.NullString{String: params.Schema, Valid: params.Schema != ""}
...
func (e *Executor) WorkflowSignalEmit(ctx context.Context, params *riverdriver.WorkflowSignalEmitParams) (*rivertype.WorkflowSignal, error) {
	...
	row, err := dbsqlc.New().WorkflowSignalEmit(schemaTemplateParam(ctx, params.Schema), e.dbtx, &dbsqlc.WorkflowSignalEmitParams{
		...
		IdempotencyKey: sql.NullString{String: ptrutil.ValOrDefault(params.IdempotencyKey, ""), Valid: params.IdempotencyKey != nil},
		Source:         sql.NullString{String: ptrutil.ValOrDefault(params.Source, ""), Valid: params.Source != nil},
		Now:            params.Now,
	})
	if err != nil {
